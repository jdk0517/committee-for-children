# Weclome to my auto-complete component demo
It fulfills all the specs as presented and comes with some integration tests to ensure functionality. To get started, you will need to have Node.js and Yarn installed. 
- `cd` into the root directory ("committee-for-children")
- run `yarn`
- once the installation is complete, run `yarn start` to launch a browser window with the application running
- to test, run `yarn test`


I bootstrapped the project with `create-react-app` as is pretty standard, so I've left that README intact below to help with any questions about the project's structure or tooling. Thanks for your consideration!
